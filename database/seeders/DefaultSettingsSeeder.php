...
class DefaultSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            // Márgenes
            ['group' => 'margins', 'key' => 'default_margin_percentage', 'value' => '1.00', 'type' => 'decimal', 'description' => 'Margen por defecto (%) - temporal'],
            ['group' => 'margins', 'key' => 'min_margin_percentage', 'value' => '1.00', 'type' => 'decimal', 'description' => 'Margen mínimo permitido (%) - temporal'],
